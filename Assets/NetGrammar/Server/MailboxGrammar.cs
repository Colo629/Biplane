...
{
    /// <summary>
    /// Base class for connection-specific actions and data handling.
    /// </summary>
    public class MailboxGrammar
    {
        ...
        /// <summary>
        /// The NetClient this mailbox belongs to.
        /// </summary>
        public NetClient ThisClient => GetNetClient();
        
        /// <summary>
        /// The room this client is currently in, or null.
        /// </summary>
        public NetRoom CurrentRoom => GetNetRoom();

        /// <summary>
        /// The client connection this MailboxGrammar is associated with.
        /// </summary>
        public ServerGrammar.ClientConnection ParentConnection;
        ...
        {
            ParentConnection.SendBytes(data, prefix);
        }

        /// <summary>
        /// Gets the NetClient this mailbox belongs to.
        /// </summary>
        /// <returns></returns>
        private NetClient GetNetClient()
        {
            return NetClient.GetClient(ParentConnection.ID);
        }
        
        /// <summary>
        /// Gets the room this client is in, or null.
        /// </summary>
        /// <returns></returns>
        private NetRoom GetNetRoom()
        {
            return NetRoom.GetRoom(GetNetClient().RoomCode);
        }
