...
namespace NetGrammar.Server.Mailboxes
{
    ...
    public class WarmLogMailbox : SimpleServerMailbox
    {
        protected override ushort MailboxPrefix => (ushort)NetDefs.MailPrefix.KeepWarm;
        ...
        public override void HandleMessage(byte[] data, ushort prefix)
        {
            ...
            Debug.Log("Got KeepWarm!");
            ReplyWarm();
        }
    
        private void ReplyWarm()
        {
