...
{
    [ServerMailbox]
    public class CloseRoomMailbox : SimpleServerMailbox
    {
        protected override ushort MailboxPrefix => (ushort)NetDefs.MailPrefix.CloseRoom;

        protected override MailboxGrammar Clone()
        {
            return new CloseRoomMailbox();
        }
